...
Notes:
Scatterplot correlation cofficient
how many status update correlation -> how many friends they, how many time they logged in
...
ggplot(data = subset(pf.fc_by_age,age_with_months <71 ), aes(age_with_months,friend_count_mean))+
  geom_line()
